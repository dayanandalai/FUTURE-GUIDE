...
const furtherTopics = [
  {
    key: 'phd',
    title: 'PH.D. IN MACHINE\nLEARNING / DATA MINING /\nAPPLIED AI',
    descriptionTitle: 'PH.D. IN MACHINE LEARNING / DATA MINING / APPLIED AI',
    description: 'A Ph.D. offers the chance to become a leading expert by conducting original research. This path is perfect for those who want to contribute to foundational theories, publish influential papers, and work at the forefront of AI innovation.',
  },
  {
    key: 'innovation',
    title: 'AI/ML-BASED INNOVATION',
    descriptionTitle: 'AI/ML-BASED INNOVATION',
    description: 'Leverage your advanced skills to drive innovation within large corporations or to found your own tech startup. This involves identifying problems that can be solved with novel AI/ML solutions and building market-ready products.',
  },
  {
    key: 'others',
    title: 'OTHERS',
    descriptionTitle: 'OTHER OPPORTUNITIES',
    description: 'Further opportunities include becoming a specialized consultant for businesses, taking on a teaching role in higher education, or working in public policy to help shape the regulations and ethics surrounding artificial intelligence.',
  },
];


export default function FurtherMlOpportunitiesPage() {
