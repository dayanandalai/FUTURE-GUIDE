...
const appDevRoles = [
	{
		...
		description:
			'A generalist role focused on creating, testing, and maintaining applications for mobile devices. They ensure the app is responsive, user-friendly, and performs well across different screen sizes and operating systems.',
		companies:
			'Google, Microsoft, Apple, Flipkart, PhonePe, Paytm, Swiggy, Zomato, Cred, Meesho, Groww, etc.',
	},
	{
		key: 'native',
		...
		description:
			'A specialist who builds applications for a single platform (either Android or iOS) using native technologies like Kotlin/Java for Android or Swift/Objective-C for iOS. This allows for the best performance and integration with the device.',
	...
	},
	{
		...
		description:
			'Uses frameworks like React Native or Flutter to write a single codebase that runs on both Android and iOS. This approach speeds up development time and is popular among startups and companies with smaller teams.',
		companies:
			'Startups, consulting firms, companies seeking cost-effective development.',
	},
	{
		key: 'flutter',
		...
		description:
			'A specialist in Google\'s Flutter framework. Flutter is known for its high-performance, expressive UI and fast development cycle, allowing developers to build beautiful native apps for mobile, web, and desktop from one codebase.',
	...
	},
	{
		...
		description:
			'A specialist in Meta\'s React Native framework. This role is ideal for developers with a web background in React, as it allows them to leverage their existing skills to build native mobile applications.',
