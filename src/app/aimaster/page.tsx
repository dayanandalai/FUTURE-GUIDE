...
const opportunityTopics = [
  {
    ...
    description: 'An M.Tech in AI leads to roles like AI/ML Engineer, Data Scientist, NLP Engineer, and Computer Vision Specialist. Graduates are hired by top tech firms like Google, Meta, and NVIDIA, as well as innovative AI startups.',
  },
  {
    key: 'further',
    ...
    description: 'After specializing in AI, you can pursue a Ph.D. to conduct groundbreaking research in areas like reinforcement learning or generative AI. This path leads to roles as a Research Scientist or a tenured Professor at leading universities.',
  },
];
  ...
  return (
    <main className="relative min-h-screen w-full bg-gradient-to-b from-[#8ebfdb] to-[#6099b8] p-4 sm:p-8 text-black font-sans overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-start w-full max-w-5xl mx-auto pt-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold mb-20 text-center px-4">M.TECH IN ARTIFICIAL INTELLIGENCE (AI)</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 w-full mb-16">
          {opportunityTopics.map((topic) => (
             <button
                ...
                onClick={() => {
                  if (topic.key === 'career') router.push('/aicareer');
                  else if (topic.key === 'further') router.push('/aifuther');
